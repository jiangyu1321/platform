(function(){
    ...
    for(i=0;i<a.length;i++){
        if(a[i].src.indexOf("ngDialog.js")>=0){
            var temp =a[i].src.replace(/ngDialog\.min\.js.*$/,"ngDialog.all.min.css");
